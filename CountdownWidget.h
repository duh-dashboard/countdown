...
class CountdownWidget : public QObject, public dashboard::IWidget {
    Q_OBJECT
    Q_INTERFACES(dashboard::IWidget)
    Q_PLUGIN_METADATA(IID IWidget_iid FILE "countdown.json")

public:
    explicit CountdownWidget(QObject* parent = nullptr);
...
private:
    QString label_;
    QString targetDate_; // ISO 8601: "YYYY-MM-DD"
};
